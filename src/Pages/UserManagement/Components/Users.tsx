    ...
    <div className="mt-9">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center">
          <div className="flex items-center">
            <span className="text-black font-medium text-sm leading-17 mr-2.5">
              Filters
            </span>
            <SingleSelect
              items={filterList}
                ...
                <tr key={i + row?.id} className="h-[68px]">
                  ...
                  <td className="px-3 text-left text-black font-medium text-sm leading-17">
                    <div className="relative" ref={morePopRef}>
                      ...
                      {openMoreFirst === row?.id ? (
                        <div className="absolute top-full left-0 bg-white rounded-5 px-5 py-4 border shadow-sm z-10">
